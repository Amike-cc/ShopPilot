...
# Usage: powershell -ExecutionPolicy Bypass -File run-acceptance.ps1
...
Run-Step 'update-runner' 'node update-runner.js'
Run-Step 'm1' 'node m1-runner.js'
Run-Step 'm2-stage1' 'node m2-runner.js stage1'
Run-Step 'm2-stage2' 'node m2-runner.js stage2'
Run-Step 'm3' 'node m3-runner.js'
Run-Step 'sec' 'node sec-runner.js'
Run-Step 'm4-full' 'node m4-runner.js'
Run-Step 'manifest' 'node release-manifest.js'
Kill-ShopPilot
