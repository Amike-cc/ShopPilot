...
const manifest = {
  ...
  dbSchemaVersion: 2,
  acceptanceSuites: [
    'node m1-runner.js（79 项，含右栏收起/展开与国内四平台目录、平台入口链路）',
  ...
  acceptanceSummary: '241 项断言全通过（M1 79 + M2 29+8 + M3 59 + sec 44 + M4 13 + 单测 9）；M4 阶段内另含 19/3/4 分项',
  artifacts: files,
  ...
  knownBoundaries: [
    '未做代码签名，构建标记 INTERNAL_BUILD；自动更新通道未实现',
