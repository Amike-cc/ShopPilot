...
async function main() {
  ...
  try {
    ...
    await cdp.shot(path.join(ROOT, 'ui-settings-config.png'))
    ...
    await cdp.shot(path.join(ROOT, 'ui-settings-about.png'))
    ...
    await cdp.shot(path.join(ROOT, 'ui-task-invite.png'))
    ...
    console.log('\n截图: ui-settings-config.png / ui-settings-about.png / ui-task-invite.png')
    cdp.close()
  } catch (e) {
