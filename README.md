...
**版本**: v0.4.26 · **构建标签**: `INTERNAL_BUILD`（未做代码签名，§21.5）  
...
| [RELEASE_NOTES.md](./RELEASE_NOTES.md) | 0.4.26 变更说明与回滚方式 |
...
```powershell
pnpm exec vitest run        # 单测 85 项（会话包 / 邀约档案与步骤 / 发票档案、多方向采集步骤、表格行清洗、CSV 转义）
