...
async function main() {
  ...
  try {
    ...
    fs.writeFileSync(path.join(ROOT, PREFIX + '-full.png'), Buffer.from(shot.data, 'base64'))
    // 顶部 120px 放大截图
    ...
    fs.writeFileSync(path.join(ROOT, PREFIX + '-top.png'), Buffer.from(shot2.data, 'base64'))
