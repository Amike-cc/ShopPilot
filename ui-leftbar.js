...
async function main() {
  ...
  try {
    ...
    await cdp.shot(path.join(root, 'ui-leftbar-expanded.png'))
    ...
    await cdp.shot(path.join(root, 'ui-leftbar-collapsed.png'))
    ...
    console.log('\n截图: ui-leftbar-expanded.png / ui-leftbar-collapsed.png')
    cdp.close()
  } catch (e) {
